...
/**
 * 
 * Class used to represent the result of the pooling container for the
...
public class TransactionResult {
	 ...
	 * @param transaction
	 */
	public TransactionResult(boolean processed, Transaction transaction) {
		super();
	...
	public String toString() {
		return "TransactionResult [id=" + id + ", jobID=" + jobID + ", processed=" + processed + ", transaction="
				+ transaction + "]";
	}
